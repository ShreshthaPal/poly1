...
contract IcecreamsNFT is ERC721A {
    address public owner;

    // Base URL for the NFTs (IPFS base URL)
    string private baseUrl = "https://gateway.pinata.cloud/ipfs/QmemRK9aS6FoSa8v4AEnRt8ZgLB3dBwPn9dzAZ2v59yMg3/";

    // Prompt description displayed to users
    string public prompt = "Icecream is a frozen dessert";

    // Maximum number of tokens that can be minted
    uint256 public maxQuantity = 100;

    // Constructor to initialize the contract with a name and symbol for the NFTs
    constructor() ERC721A("IcecreamsNFT", "INFT") {
        owner = msg.sender;
    }
